...
public:
	...
	static void loadDataSet(std::string path_directory, pcl::PointCloud<pcl::PointXYZI>::Ptr pointCloud, int * * voxels, int &w, int &h, int &d, int threshold, float pixSize);//loadDataSet(std::string path);
